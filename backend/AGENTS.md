...
- System prompt generated by `apply_prompt_template()` with skills, memory, and subagent instructions; custom agents additionally include their own name and append their persisted `SOUL.md`
