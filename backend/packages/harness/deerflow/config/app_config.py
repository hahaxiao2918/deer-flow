...
from deerflow.config.tool_result_sanitization_config import ToolResultSanitizationConfig
...
class AppConfig(BaseModel):
    ...
    tool_result_sanitization: ToolResultSanitizationConfig = Field(
        default_factory=ToolResultSanitizationConfig,
        description="Untrusted remote tool-result content configuration",
    )
    ...
    default_agent: DefaultAgentConfig = Field(
        default_factory=DefaultAgentConfig,
        description="Capability filters for the built-in default lead agent.",
    )
